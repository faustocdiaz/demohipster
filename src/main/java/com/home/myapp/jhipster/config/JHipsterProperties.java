package com.home.myapp.jhipster.config;
...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "demohipster@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "demohipster API";

        private String description = "demohipster API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "demohipster";
